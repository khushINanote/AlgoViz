            ...
            <div className="max-w-md w-full bg-secondary-bg dark:bg-sidebar rounded-xl shadow-xl border border-border dark:border-border p-8">
                <div className="text-center mb-8">
                    <div className="w-16 h-16 bg-primary-accent dark:bg-primary-accent/50 rounded-full flex items-center justify-center mx-auto mb-4">
                        <UserPlus size={28} className="text-primary-accent dark:text-primary-accent" />
                    </div>
                    <h2 className="text-2xl font-bold text-primary-text dark:text-secondary-bg">Create an Account</h2>
                    <p className="text-secondary-text dark:text-secondary-text mt-2">Start your algorithm journey</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                        <label className="block text-sm font-medium text-slate-700 dark:text-secondary-text mb-2">Full Name</label>
                        <input
                            type="text"
                            required
                    ...
                    <button type="submit" className="w-full bg-primary-accent hover:bg-primary-accent text-secondary-bg font-semibold py-3 rounded-xl transition-colors shadow-md mt-6">
                        Sign Up
                    </button>
                </form>

                <p className="mt-6 text-center text-secondary-text dark:text-secondary-text">
                    Already have an account? <Link to="/login" className="text-primary-accent dark:text-primary-accent font-semibold hover:underline">Log in</Link>
                </p>
            </div>
        </div>
    );
