            ...
            <section className="bg-gradient-to-br from-indigo-50 to-white dark:from-slate-900 dark:to-slate-800 py-20 lg:py-32 overflow-hidden relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center max-w-3xl mx-auto">
                        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-slate-900 dark:text-white tracking-tight leading-tight mb-6 sm:mb-8">
                        ...
                        <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-300 mb-8 sm:mb-10 leading-relaxed px-2 sm:px-0">
            ...
            <section className="py-20 bg-white dark:bg-slate-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12 sm:mb-16">
                        <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">Why Learn with AlgoViz?</h2>
                        <p className="mt-4 text-lg sm:text-xl text-slate-600 dark:text-slate-400">Everything you need to master algorithms</p>
                    </div>
...
const FeatureCard = ({ icon, title, description }) => (
    <div className="bg-slate-50 dark:bg-slate-800 p-6 sm:p-8 rounded-2xl shadow-sm hover:shadow-md transition-shadow border border-slate-100 dark:border-slate-700">
        <div className="w-12 h-12 sm:w-14 sm:h-14 bg-white dark:bg-slate-700 rounded-xl flex items-center justify-center mb-5 sm:mb-6 shadow-sm">
            {icon}
        </div>
